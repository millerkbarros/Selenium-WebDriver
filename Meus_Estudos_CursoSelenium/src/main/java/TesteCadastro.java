...
public class TesteCadastro {
	...
	public void deveInteragirComAlertPrompt() {
		...
		driver.findElement(By.id("elementosForm:nome")).sendKeys("Miller");
		driver.findElement(By.id("elementosForm:sobrenome")).sendKeys("Cardoso Barross");
		...
		Assert.assertTrue(driver.findElement(By.id("descNome")).getText().endsWith("Miller"));
		Assert.assertEquals("Sobrenome: Cardoso Barros", driver.findElement(By.id("descSobrenome")).getText());
